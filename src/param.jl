...
create_paramop(paramKd::AbsArrComplex,  # material parameter array
               ...
               ∆l′⁻¹::Tuple{Vararg{AbsVecNumber}},  # inverse of line segments to divide by (defined at field voxel corners); vectors of length N
    ...
    create_paramop(paramKd, SVec{K}(gt₀), SVec{K}(N), ∆l, ∆l′⁻¹, SVec{K}(isbloch), SVec{K}(e⁻ⁱᵏᴸ), order_cmpfirst=order_cmpfirst)
